...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 750, 130, 30, 30, 3),
    new Obstaculo('imagenes/valla_horizontal.png', 850, 130, 30, 30, 3),
    new Obstaculo('imagenes/valla_horizontal.png', 760, 400, 30, 30, 3),
    new Obstaculo('imagenes/valla_horizontal.png', 850, 400, 30, 30, 3),
    new Obstaculo('imagenes/valla_horizontal.png', 770, 320, 30, 30, 3),
    new Obstaculo('imagenes/valla_horizontal.png', 835, 220, 30, 30, 3),
    new Obstaculo('imagenes/valla_vertical.png', 440, 110, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 660, 120, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 230, 390, 30, 30, 1),
    ...
    new Obstaculo('imagenes/bache.png', 310, 480, 30, 30, 3),
    new Obstaculo('imagenes/bache.png', 550, 75, 30, 30, 3),
    new Obstaculo('imagenes/bache.png', 500, 300, 30, 30, 3),
    new Obstaculo('imagenes/auto_verde_abajo.png', 460, 250, 15, 30, 2),
    new Obstaculo('imagenes/auto_verde_derecha.png', 320, 180, 30, 15, 2),
  ],
  ...
  enemigos: [
    new ZombieCaminante ('imagenes/zombie3.png', 600, 120, 10, 10, 1,{desdeX:300, hastaX:850, desdeY:40, hastaY:150}),
    new ZombieCaminante ('imagenes/zombie2.png', 420, 405, 10, 10, 1,{desdeX:70, hastaX:550, desdeY:200, hastaY:250}),
    new ZombieCaminante ('imagenes/zombie1.png', 90, 290, 10, 10, 1,{desdeX:70, hastaX:250, desdeY:280, hastaY:360}),
    new ZombieCaminante ('imagenes/zombie2.png', 805, 400, 10, 10, 1,{desdeX:750, hastaX:850, desdeY:300, hastaY:560}),
    new ZombieCaminante ('imagenes/zombie3.png', 400, 450, 10, 10, 1,{desdeX:60, hastaX:550, desdeY:400, hastaY:500}),
    new ZombieConductor ('imagenes/tren_vertical.png', 644, 0, 30, 90, 2, {desdeY:0, hastaY:500}, 'v'),
    new ZombieConductor ('imagenes/tren_vertical.png', 678, 0, 30, 90, 4, {desdeY:0, hastaY:500}, 'v'),
    new ZombieConductor ('imagenes/tren_horizontal.png', 400, 322, 90, 30, 5, {desdeX:0, hastaX:900}, 'h'),
  ]
